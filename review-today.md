...
- **Issue:** The user message is saved to DB at line 113-122 (`insert...role: 'user'`). Then, on the emergency branch (line 174), it's inserted _again_ as part of a bulk insert: `insert([{ role: 'user', content: currentMessageText }, { role: 'assistant', content: result.emergencyMessage }])`. Every emergency message gets duplicated in the `messages` table.
